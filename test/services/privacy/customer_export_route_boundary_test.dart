...
void main() {
  group('customer privacy export route boundary', () {
    test('visible export screen uses backend verified user data export route', () {
    ...
    test('user API provider exposes account export and deactivation routes', () {
      final userApi = File('lib/services/api/providers/user_api.dart')
          .readAsStringSync();
