...
void main() {
  ...
  goldenGroup('AddressInputScreen Golden Tests', () {
  ...
  goldenGroup('ExternalAmountScreen Golden Tests', () {
  ...
  goldenGroup('ExternalConfirmScreen Golden Tests', () {
  ...
  goldenGroup('ExternalResultScreen Golden Tests', () {
  ...
  goldenGroup('ScanAddressQrScreen Golden Tests', () {
    testWidgets('light mode', (tester) async {
      await tester.binding.setSurfaceSize(GoldenTestConfig.defaultSize);
      await tester.pumpWidget(
