...
class AppReviewService {
  ...
  Future<void> _checkAndShowReview() async {
    ...
    try {
      ...
      // Track analytics
      _analytics.setUserProperty(name: 'review_prompt_shown', value: 'true');
  ...
  Future<void> markAsReviewed() async {
    try {
      ...
      // Track analytics
      _analytics.setUserProperty(name: 'user_reviewed', value: 'true');
  ...
  Future<void> openAppStore() async {
    try {
      ...
      // Track analytics
      _analytics.setUserProperty(name: 'manual_review_opened', value: 'true');
