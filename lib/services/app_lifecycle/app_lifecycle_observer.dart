...
const _minimumLockGracePeriod = Duration(seconds: 60);
...
class AppLifecycleObserver extends WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    switch (state) {
      ...
      case AppLifecycleState.hidden:
        ...
        try {
          _ref.read(realtimeServiceProvider).pause();
        } catch (_) {}
      ...
      case AppLifecycleState.resumed:
        ...
        try {
          _ref.read(realtimeServiceProvider).resume();
        } catch (_) {}
        break;
  ...
  void _startLockTimer() {
    ...
    final effectiveDelay = lockDelay < _minimumLockGracePeriod
        ? _minimumLockGracePeriod
        : lockDelay;

    _lockTimer = Timer(effectiveDelay, () {
      _triggerAutoLock();
    });
  }
