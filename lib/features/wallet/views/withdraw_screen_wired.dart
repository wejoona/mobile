...
class WithdrawScreenWired extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WithdrawScreenWired> createState() =>
      _WithdrawScreenWiredState();
}
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              '${AppLocalizations.of(context)!.wallet_availableBalance}: ${balance.toStringAsFixed(2)} USDC',
            ...
            Text(
              AppLocalizations.of(context)!.withdraw_method,
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.md),
            Text(
              AppLocalizations.of(context)!.withdraw_initiated,
              style: Theme.of(context).textTheme.headlineSmall,
            ),
            if (result.reference != null) ...[
              const SizedBox(height: AppSpacing.sm),
              Text(
                '${AppLocalizations.of(context)!.billPayments_reference}: ${result.reference}',
              ),
            ],
