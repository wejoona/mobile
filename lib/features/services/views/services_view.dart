...
class ServicesView extends ConsumerWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              if (_getFinancialServices(flags, l10n).isNotEmpty) ...[
                ...
                _buildServicesGrid(
                  context,
                  _getFinancialServices(flags, l10n),
                  colors,
                ),
                const SizedBox(height: AppSpacing.xxl),
              ],
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _ServiceCard(
          ...
          onTap: () => context.fsmPush(service.route),
          colors: colors,
        );
      },
    );
  ...
  List<ServiceItem> _getCoreServices(
  ...
  List<ServiceItem> _getFinancialServices(
    Map<String, bool> flags,
    AppLocalizations l10n,
  ) {
    final services = <ServiceItem>[];
  ...
  List<ServiceItem> _getBillServices(
    Map<String, bool> flags,
    AppLocalizations l10n,
  ) {
    final services = <ServiceItem>[];
  ...
  List<ServiceItem> _getToolsServices(
    Map<String, bool> flags,
    AppLocalizations l10n,
  ) {
    final services = <ServiceItem>[];
