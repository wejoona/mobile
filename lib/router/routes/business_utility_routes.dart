...
List<RouteBase> businessUtilityRoutes() => [
  // Sub-Business Routes
  GoRoute(
    path: '/sub-businesses',
    pageBuilder: (context, state) =>
        AppPageTransitions.fade(state: state, child: const SubBusinessesView()),
  ),
  GoRoute(
  ...
  GoRoute(
    path: '/bulk-payments',
    pageBuilder: (context, state) =>
        AppPageTransitions.fade(state: state, child: const BulkPaymentsView()),
  ),
  GoRoute(
  ...
  GoRoute(
    path: '/catalog',
    pageBuilder: (context, state) =>
        AppPageTransitions.fade(state: state, child: const WidgetCatalogView()),
  ),
];
